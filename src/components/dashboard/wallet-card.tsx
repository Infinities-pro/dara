      ...
      <Card className="group relative overflow-hidden rounded-2xl border-2 border-white/20 bg-black/20 p-6 shadow-2xl backdrop-blur-md transition-all duration-300 hover:border-white/30">
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            {wallet?.active && (
              <div className="inline-flex items-center rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-medium text-emerald-400">
                <CheckCircle2 className="mr-1.5 h-3.5 w-3.5" />
                Active
              </div>
            )}
            {isPrivyWallet && wallet?.delegated && (
              <div className="inline-flex items-center rounded-full bg-white/5 px-3 py-1 text-xs font-medium text-white/60">
          ...
          <div className="space-y-1">
            <Label className="text-xs font-normal text-white/50">
              Available Balance
            </Label>
          ...
          <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap">
            ...
            <Button
              variant="outline"
              className="w-full sm:w-auto border-white/20 bg-white/[0.02] hover:bg-white/[0.05]"
            ...
            {isPrivyWallet && (
              <>
                ...
                <Button
                  variant="outline"
                  className={cn(
                    'w-full sm:w-auto border-white/20 bg-white/[0.02]',
                    wallet?.delegated ? 'hover:bg-destructive/10' : 'hover:bg-white/[0.05]'
                  )}
