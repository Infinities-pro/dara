...
const suggestions = [
  {
    title: 'Give me top 5 trending tokens.',
    description: 'I want the most trending tokens under 1m.',
  },
  {
    title: "What's the sentiment like on X?",
    description: 'Do a sentiment analysis on X.',
  },
  {
    title: "How old is this project's domain?",
    description: 'Show me the WHOIS record of this domain.',
  },
  {
    title: 'Is this token bundled?',
    description: 'Tell me if this memecoin is bundled.',
  },
  {
    title: 'Can you copytrade someone?',
    description: "Copy trade Donald Trump's wallet.",
  },
  {
    title: 'Did anyone famous tweet a CA?',
    description: 'Notify me when anyone famous launches a coin.',
  },
];
                ...
                {message.role === 'user' ? (
                  <div className="flex max-w-[80%] flex-col gap-1">
                    <div className="ml-auto flex items-end gap-2">
                      <div className="rounded-2xl rounded-br-none bg-white/[0.06] px-4 py-2">
        ...
        <div className="relative mx-auto w-full max-w-3xl px-4 py-4">
          {messages.length === 0 && (
            <div className="mb-6 space-y-6">
              <div className="rounded-2xl bg-white/[0.02] p-6 backdrop-blur-sm">
                <h3 className="text-2xl font-semibold">
                  talk to Dara like a fren.
                </h3>
                <p className="text-white/60">
                  get token info, swap assets, set alerts, investigate, audit &
                  more - all in one.
                </p>
              </div>
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (textareaRef.current) {
                        textareaRef.current.value = suggestion.title;
                        textareaRef.current.focus();
                      }
                    }}
                    className="rounded-2xl bg-white/[0.02] p-4 text-left transition-colors hover:bg-white/[0.04]"
                  >
          ...
          <div className="rounded-2xl bg-white/[0.02] p-4 backdrop-blur-sm">
            <form onSubmit={handleFormSubmit} className="space-y-4">
              <div className="relative">
                <Textarea
                  ...
                  className="min-h-[100px] w-full resize-none border-0 bg-transparent px-4 py-[1.3rem] text-base focus-visible:ring-0"
                  maxLength={MAX_CHARS}
                />
              </div>
              ...
              <div className="flex gap-2 overflow-x-auto py-2">
                {quickActions.map((action) => (
                  <button
                    key={action.label}
                    type="button"
                    className="flex items-center gap-2 rounded-full bg-white/[0.02] px-4 py-2 text-sm hover:bg-white/[0.04]"
                  >
